...
function CreatePage() {
  ...
  return (
    <div className="ml-4"> {/* Adjust the margin value as needed */}
      ...
      <div className="text-center">
        {selectedOption === 'app' && <AppContent />}
        {selectedOption === 'news' && <NewsContent />}
        {selectedOption === 'blog' && <BlogContent />}
      </div>
    </div>
  );
};
...
const AppContent = () => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log('Form data:', { ...formData, appIcon, screenshots });
  };

  return (
    <div className="centered-container">
    <form className='centered-form' ref={formData} onSubmit={handleSubmit}>
      <div style={{ marginRight: 225 }} className="space-y-12">
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <div className="text-start mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
